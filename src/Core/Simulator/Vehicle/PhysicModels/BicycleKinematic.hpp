...
// *****************************************************************************
//! \brief Simple car kinematic using the bicycle kinematic equations.
//! The position (x, y) of the car is the middle of the rear axle.
//! [../doc/pics/TricycleVehicle.png]
//! [doc/pics/BicycleKinematicEq.png]
// *****************************************************************************
class BicycleKinematic: public PhysicModel
{
public:

    //--------------------------------------------------------------------------
    explicit BicycleKinematic(VehicleShape const& shape)
        : PhysicModel(shape),
