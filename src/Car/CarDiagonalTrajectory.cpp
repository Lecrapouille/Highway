...
bool DiagonalTrajectory::init(Car& car, Parking const& parking)
{
...
//------------------------------------------------------------------------------
bool DiagonalTrajectory::computePathPlanning(Car const& car, Parking const& parking)
{
...
//------------------------------------------------------------------------------
void DiagonalTrajectory::generateReferenceTrajectory(Car const& car, float const VMAX, float const ADES)
{
