...
//------------------------------------------------------------------------------
bool ParallelTrajectory::init(Car& car, sf::Vector2f const& destination)
{
    ...
    {
        if (!computePathPlanning(car, destination))
            return false;
...
//------------------------------------------------------------------------------
bool ParallelTrajectory::computePathPlanning(Car const& car, sf::Vector2f const& destination)
{
